...
// AddOptions are options to apply when adding the onmetal exposure webhook to the manager.
type AddOptions struct {
	// ETCDStorage is the etcd storage configuration.
	ETCDStorage config.ETCDStorage
}

var logger = log.Log.WithName("onmetal-controlplaneexposure-webhook")
