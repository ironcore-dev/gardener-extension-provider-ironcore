...
func (in *CloudProfileConfig) DeepCopyInto(out *CloudProfileConfig) {
	*out = *in
	...
	if in.VolumeClasses != nil {
		...
		*out = make([]VolumeClassDefinition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VolumeClassDefinition) DeepCopyInto(out *VolumeClassDefinition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VolumeClassDefinition.
func (in *VolumeClassDefinition) DeepCopy() *VolumeClassDefinition {
	if in == nil {
		return nil
	}
	out := new(VolumeClassDefinition)
	in.DeepCopyInto(out)
	return out
}
