...
func autoConvert_v1alpha1_InfrastructureStatus_To_ironcore_InfrastructureStatus(in *InfrastructureStatus, out *ironcore.InfrastructureStatus, s conversion.Scope) error {
	...
	// WARNING: in.PrefixRefs requires manual conversion: inconvertible types ([]github.com/ironcore-dev/ironcore/api/common/v1alpha1.LocalUIDReference vs github.com/ironcore-dev/ironcore/api/common/v1alpha1.LocalUIDReference)
