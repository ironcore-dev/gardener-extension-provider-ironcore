...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Region)(nil), (*config.Region)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Region_To_config_Region(a.(*Region), b.(*config.Region), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.Region)(nil), (*Region)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_Region_To_v1alpha1_Region(a.(*config.Region), b.(*Region), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	out.Regions = *(*[]config.Region)(unsafe.Pointer(&in.Regions))
	return nil
}
...
func autoConvert_v1alpha1_Region_To_config_Region(in *Region, out *config.Region, s conversion.Scope) error {
	out.Name = in.Name
	out.KubeConfigStub = in.KubeConfigStub
	return nil
}

// Convert_v1alpha1_Region_To_config_Region is an autogenerated conversion function.
func Convert_v1alpha1_Region_To_config_Region(in *Region, out *config.Region, s conversion.Scope) error {
	return autoConvert_v1alpha1_Region_To_config_Region(in, out, s)
}

func autoConvert_config_Region_To_v1alpha1_Region(in *config.Region, out *Region, s conversion.Scope) error {
	out.Name = in.Name
	out.KubeConfigStub = in.KubeConfigStub
	return nil
}

// Convert_config_Region_To_v1alpha1_Region is an autogenerated conversion function.
func Convert_config_Region_To_v1alpha1_Region(in *config.Region, out *Region, s conversion.Scope) error {
	return autoConvert_config_Region_To_v1alpha1_Region(in, out, s)
}
